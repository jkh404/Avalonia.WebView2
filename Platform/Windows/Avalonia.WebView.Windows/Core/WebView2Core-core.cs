...
using Avalonia.WebView.Windows.Helpers;
using Microsoft.Web.WebView2.Core;
using WebView.Core;
using WebView.Core.Enums;
using WebView.Core.Events;
using WebView.Core.Helpers;
...
partial class WebView2Core
{
    ...
    {
        _callBack.PlatformWebViewNavigationCompleted(this, new WebViewUrlLoadedEventArg(e.IsSuccess,e) );
    }
